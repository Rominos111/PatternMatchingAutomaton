        ...
        for (int i = 0; i < word.length(); i++) {
            ...
            if (lien == nullptr) {
                ...
                if (i == word.length() - 1) {
                    ...
                    base->addLien(new Lien(word[i], new Etat));
                }
            }
            else {
                // Contient
...
Automate::Automate() {
    ...
    //resultats de 13
    res.clear();
    res.emplace_back("rene");
    res.emplace_back("irene");
    //etat 13
